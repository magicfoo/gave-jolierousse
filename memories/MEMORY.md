...
§
Gerald has a son named Arthur.
§
Gerald is considering entering Jolie Rousse in the Baja Ha-Ha 2026 cruisers rally (San Diego to Cabo San Lucas).
§
Gerald prefers voice messages delivered as Telegram voice bubbles (sendVoice), not as file attachments. If TTS output arrives as a .ogg file in a group chat, it's a Hermes gateway routing issue — the [[audio_as_voice]] tag should trigger sendVoice, not sendDocument.
§
